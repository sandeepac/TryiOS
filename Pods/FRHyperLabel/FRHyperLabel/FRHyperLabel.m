...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:47/255.0 green:201/255.0 blue:143/255.0 alpha:1];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:47/255.0 green:201/255.0 blue:143/255.0 alpha:1];
	}
}
...
- (NSValue *)attributedTextRangeForPoint:(CGPoint)point {
	...
	CGPoint reversePoint = CGPointMake(point.x - 50, CGRectGetHeight(self.frame) - point.y);
